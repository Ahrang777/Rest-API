package com.restapi.restApi.advice;

import com.restapi.restApi.advice.exception.*;
import com.restapi.restApi.advice.exception.type.ExceptionType;
...
import static com.restapi.restApi.advice.exception.type.ExceptionType.*;
...
//        e.getStackTrace();
    ...
    /**
     * 전달한 Jwt 가 정상적이지 않은 경우 발생 시키는 예외
     */
    @ExceptionHandler(CAuthenticationEntryPointException.class)
    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    protected Response authenticationEntrypointException(CAuthenticationEntryPointException e) {
        log.error("[exceptionHandler] ex", e);
        return getFailureResponse(AUTHENTICATION_ENTRY_POINT_EXCEPTION);
    }
    ...
    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    protected Response accessDeniedException(CAccessDeniedException e) {
        log.error("[exceptionHandler] ex", e);
    ...
    protected Response userNotFoundException(CUserNotFoundException e) {
        log.error("[exceptionHandler] ex", e);
        return getFailureResponse(USER_NOT_FOUND);
    }*/
    ...
    protected Response emailLoginFailedException(CEmailLoginFailedException e) {
        log.error("[exceptionHandler] ex", e);
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    protected Response emailSignupFailedException(CEmailSignupFailedException e) {
        log.error("[exceptionHandler] ex", e);

    }*/

    /*
    validation의 경우 bindingResult 에러 >> 타입 안맞아서 객체 생성 안된 경우
